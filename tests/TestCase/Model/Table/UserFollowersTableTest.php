...
class UserFollowersTableTest extends TestCase
{
    ...
    {
        parent::setUp();
        $config = TableRegistry::getTableLocator()->exists('UserFollowers') ? [] : ['className' => UserFollowersTable::class];
        $this->UserFollowers = TableRegistry::getTableLocator()->get('UserFollowers', $config);
    }
