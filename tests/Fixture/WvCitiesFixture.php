 ...
 *
 */
class WvCitiesFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        '_constraints' => [
            ...
            'wv_cities_ibfk_1' => ['type' => 'foreign', 'columns' => ['state_id'], 'references' => ['wv_states', 'id'], 'update' => 'restrict', 'delete' => 'restrict', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
